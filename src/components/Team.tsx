const ORG = ({ name, position, path }: { name: string, position: string, path: string }) => {
    return <div className="flex flex-col col-span-4 md:col-span-2 items-center gap-2 w-42">
...
export default function Team() {
    return (
        <section className="min-h-screen flex flex-col items-start justify-center px-6 mx-auto ">
            ...
            <div className="grid grid-cols-8 gap-5 mx-auto mt-10">

                <ORG name="Гонсеровська Богдана" position="Main Organaizer" path="/bodya.jpg" />
